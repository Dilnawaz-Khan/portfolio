      ...
      <div className="footer--link--container">
        ...
        <div className="footer--social--icon">
          <ul>
            <li>
              <a
                href="https://www.linkedin.com/in/dilnawazkhan1996"
            ...
            <li>
              <a
                href="https://m.me/Dill0607?hash=AbYjAx9jwHeC2hqD&source=qr_link_share"
                className="navbar--content"
                target="_blank"
                rel="noreferrer"
              >
            ...
            <li>
              <a
                href="http://instagra.com/dill_sayss"
                className="navbar--content"
                target="_blank"
                rel="noreferrer"
              >
            ...
            <li>
              <a
                href="https://twitter.com/this_is_dill"
                className="navbar--content"
                target="_blank"
                rel="noreferrer"
              >
